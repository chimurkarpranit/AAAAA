    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                strBuildObject.Append(" where FirstName='" + TxtUserName.Text + "' COLLATE Latin1_General_CS_AS AND LastName='" + TxtPassword.Text + "' COLLATE Latin1_General_CS_AS ;");
                cmd = new MySqlCommand(strBuildObject.ToString(), con);
                usrpsw = cmd.ExecuteScalar();
                if (usrpsw != null)
                {
                    Session["UserName"] = TxtUserName.Text; //Username stored in Session
